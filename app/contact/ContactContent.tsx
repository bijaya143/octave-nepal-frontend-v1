      ...
      <Container className="py-10 md:py-14">
        <div className="mb-6">
          ...
          <p className="hidden sm:block mt-2 text-sm text-[color:var(--color-neutral-600)]">
            Have questions about courses, cohorts, or payments? Send us a message and we'll get back soon.
          </p>
        </div>
              ...
              <CardContent className="relative py-6">
                ...
                <form onSubmit={handleSubmit} className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div className="sm:col-span-2 flex items-center justify-end gap-3 pt-1">
                    <Button type="submit" size="lg" disabled={loading || !name || !email || !message}>
                ...
                <div className="mt-3 space-y-3 text-sm">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="text-[color:var(--foreground)] font-medium">Email</div>
                      <div className="text-[color:var(--color-neutral-700)] group-hover:text-[color:var(--color-primary-700)]">hello@octavenepal.com</div>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <div className="text-[color:var(--foreground)] font-medium">Phone</div>
                      <div className="text-[color:var(--color-neutral-700)] group-hover:text-[color:var(--color-primary-700)]">+977 980-0000000</div>
                    </div>
                  </a>
                  ...
                  <div className="flex items-center gap-3 rounded-lg border border-[color:var(--color-neutral-200)] bg-white/95 backdrop-blur px-3 py-3">
                    ...
                    <div className="flex-1">
                      <div className="text-[color:var(--foreground)] font-medium">Address</div>
                      <div className="text-[color:var(--color-neutral-700)]">Kathmandu, Nepal</div>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent className="relative py-5">
              ...
              <div className="group mt-3 text-sm flex items-center gap-3 rounded-lg border border-[color:var(--color-neutral-200)] bg-white/95 backdrop-blur px-3 py-3">
                ...
                <div className="flex-1">
                  <div className="text-[color:var(--foreground)] font-medium">Sunday - Friday</div>
                  <div className="text-[color:var(--color-neutral-700)]">10:00 AM - 6:00 PM (NPT)</div>
                </div>
              </div>
              <div className="mt-2 text-xs md:text-sm text-[color:var(--color-primary-700)]">
                Typical response time: within 2 hours <span className="text-[color:var(--color-primary-400)]">•</span> Closed on Saturday and public holidays
              </div>
            </CardContent>
          </Card>
          </div>
