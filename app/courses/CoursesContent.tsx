...
function FiltersForm() {
  return (
    <>
      <h2 className="text-base font-semibold mb-4" style={{ fontFamily: "var(--font-heading-sans)" }}>Filters</h2>
      <div className="space-y-4">
        ...
        <Button variant="secondary" className="w-full">Reset filters</Button>
      </div>
    </>
  );
}
      ...
      <div className="grid lg:grid-cols-[260px_1fr] gap-6 items-start">
        ...
        <section>
          <div className="flex items-center justify-between gap-2 mb-4">
            <div>
              <h1 className="text-xl md:text-2xl font-semibold" style={{ fontFamily: "var(--font-heading-sans)" }}>All courses</h1>
              <p className="hidden sm:block text-sm text-[color:var(--color-neutral-600)]">Hand-picked modern curriculum</p>
            </div>
