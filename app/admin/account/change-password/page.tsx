      ...
      <Container>
        <div className="mb-5 w-full max-w-xl md:max-w-2xl mx-auto">
          <div>
            ...
            <p className="text-sm text-[color:var(--color-neutral-600)]">Update your account password.</p>
          </div>
        </div>

        <form onSubmit={handleSubmit} className="grid gap-5 md:gap-6 w-full max-w-xl sm:max-w-xl md:max-w-2xl lg:max-w-2xl mx-auto">
          <Card>
            <CardHeader className="mb-4">
              <h2 className="text-base font-semibold" style={{ fontFamily: "var(--font-heading-sans)" }}>
                Password details
              </h2>
              <p className="mt-1 text-sm text-[color:var(--color-neutral-600)]">Ensure your new password is strong and unique.</p>
            </CardHeader>
