      ...
      <section className="py-5 md:py-10">
        <Container className="max-w-3xl">
          ...
          <div className="mt-8 space-y-6 leading-relaxed">
            <p>
              Welcome to {SITE_NAME}. By accessing or using our website and
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-[color:var(--color-neutral-700)]">
                ...
                and not for any unlawful purpose. We may modify, suspend, or
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-[color:var(--color-neutral-700)]">
                If you purchase courses or services, you agree to provide
                accurate billing information. All fees are non-refundable unless
                stated otherwise.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-[color:var(--color-neutral-700)]">
                ...
                course materials, is the property of {SITE_NAME} or its
